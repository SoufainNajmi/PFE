...
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
    <h2>Mes Factures (Fournisseur)</h2>
</div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('fournisseur.orders.invoice', $order->id) }}" class="btn" style="padding: 0.25rem 0.5rem; font-size: 0.8rem; background: var(--secondary);" title="Télécharger PDF">📄 Télécharger</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
